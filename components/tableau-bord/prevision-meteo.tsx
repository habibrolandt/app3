...
export function PrevisionMeteo() {
  const [activeTab, setActiveTab] = useState<string>("meteoAujourdhui")
  ...
  const impactIrrigation = weatherData ? calculerImpactIrrigation() : null
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="meteoAujourdhui">Aujourd'hui</TabsTrigger>
            <TabsTrigger value="meteoPrevisions">Prévisions</TabsTrigger>
          </TabsList>
          <TabsContent value="meteoAujourdhui" className="mt-4">
            {/* Météo actuelle */}
          ...
          <TabsContent value="meteoPrevisions" className="mt-4">
            {/* Prévisions 5 jours */}
